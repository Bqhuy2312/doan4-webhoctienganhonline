    ...
    <div class="profile-card">
        ...
        <div class="user-info-header">
            @if(Str::startsWith(Auth::user()->avatar, 'http'))
                <img src="{{ Auth::user()->avatar }}" alt="avatar" class="avatar-image">
            @else
            ...
            @forelse($user->courses as $course)
                <li class="progress-item">
                    ...
                    <div class="progress-bar-container">
                        <div class="progress-bar-fill" style="width: {{ $course->pivot->progress . '%' }}">
                        </div>
                    </div>

                    <div class="progress-actions">
                        <a href="{{ route('user.resume', $course->id) }}" class="action-button btn-green">
                            Tiếp tục học
                        </a>

                        <a href="{{ route('user.course.detail', $course->id) }}" class="action-button btn-blue">
                            Chi tiết
                        </a>
